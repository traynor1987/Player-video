...
dependencies {
    ...
    implementation("androidx.adaptive:adaptive:1.1.0")
    implementation("androidx.adaptive:adaptive-layout:1.1.0")
...
tasks.register("requireReleaseSigning") {
    doLast { check(hasReleaseSigning) { "Release signing credentials are required." } }
}
